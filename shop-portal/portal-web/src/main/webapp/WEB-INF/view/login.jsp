...
<div class="content content-nav-base  login-content">
    ...
    <div class="login-bg">
        <div class="login-cont w1200">
            <div class="form-box">
                <form id="from_login" class="layui-form" action="${pageContext.request.contextPath}/home/authentication" method="post">
                    <legend>手机号登录</legend>
                    <div class="layui-form-item">
                        <div class="layui-inline iphone">
                            <div class="layui-input-inline">
                                <i class="layui-icon layui-icon-cellphone iphone-icon"></i>
                                <input type="tel" name="username" id="username" lay-verify="required|phone" placeholder="请输入手机号" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline iphone">
                            <div class="layui-input-inline">
...
<script type="text/javascript">
    layui.config({
        ...
        function submit_login() {
            ...
            $.ajax({
                type:"post",
                url:"${pageContext.request.contextPath}/home/authentication",
