package com.hello.strategy.pay.unionPay;
...
//
//        /***商户接入参数***/
//        requestData.put("merId", map.get("MERCHANT_ID").toString());    	          			  //商户号码，请改成自己申请的正式商户号或者open上注册得来的777测试商户号
...
//        requestData.put("txnAmt", map.get("PAY_AMOUNT").toString());             			      //交易金额，单位分，不要带小数点
...
//        requestData.put("frontUrl", "http://niu.free.idcfengye.com/ACPSample_B2C/backRcvResponse");
//
...
//        requestData.put("backUrl", "http://localhost:8080/ACPSample_B2C/frontRcvResponse");
//
//        // 订单超时时间。
