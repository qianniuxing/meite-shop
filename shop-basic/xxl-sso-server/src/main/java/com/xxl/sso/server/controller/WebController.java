...
import com.xxl.sso.server.feign.IUserFeign;
...
public class WebController {
    ...
    public String doLogin(HttpServletRequest request,
        ...
        PageData loginResult = this.userFeign.ssoLogin(param);
        if (!"200".equals(loginResult.getString("code"))) {
            redirectAttributes.addAttribute("errorMsg", loginResult.getString("msg"));
